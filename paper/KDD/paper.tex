...
\begin{table*}
    ...
    \begin{tabular}{cccc}
        ...
        MNIST\footnotemark & 10.24 & 92.59\% & 92.33\% \\
        \bottomrule
    \end{tabular}
    \label{tab:classif:2}
\end{table*}

\footnotetext{For MNIST, we handled the data differently. Because running gradient descent caused overflows even for learning rates of $10^{-4}$, we standardized the data first.}
