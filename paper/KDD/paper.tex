...
\definecolor{backcolour}{rgb}{0.9568, 0.9608, 0.9725}
...
% TODO: Rights management information. 
...
\begin{figure}
    ...
    \Description{A downward curved graph of the loss function over the number of iterations on the California housing prices data set.}
    \label{fig:leastsq:1}
\end{figure}
...
\begin{figure}
    ...
    \Description{Two side-by-side graphs, showing the training and validation accuracies respectively, for both the learning rates.}
    \label{fig:classif:1}
\end{figure}
...
\begin{figure}
    ...
    \Description{Two side-by-side graphs, showing the accuracy scores for each learning rate. Each graph shows the training and validation accuracy scores for that learning rate.}
    \label{fig:classif:2}
\end{figure}
...
\begin{figure}
    ...
    \Description{Two screen caputres, showing the precision, recall, and F1-scores tabulated class-wise for each learning rate.}
    \label{fig:1}
\end{figure}
...
\lstinputlisting[language=Python]{code/reg_exp.py}
...
\lstinputlisting[language=Python]{code/softmax.py}
The main loop is shown below.
\lstinputlisting[language=Python]{code/softmax_main.py}

\subsection{MNIST}
The data pre-processing for the MNIST data used the below code:
\lstinputlisting[language=Python]{code/mnist_pre.py}
The model itself was implemented using Keras:
\lstinputlisting[language=Python]{code/mnist_model.py}
\end{document}
